  ...
  try {
    ...
    try {
      ...
      await bot.telegram.sendMessage(
        OWNER_ID,
`<blockquote>⬡═―—⊱ ⎧ 𝙐𝙋𝘿𝘼𝙏𝙀 ☇ 𝘿𝙀𝙏𝙀𝘾𝙏 ⎭ ⊰―—═⬡</blockquote>
⌑ Name Script : Croslext Silent
⌑ Status : Update Baru Terdeteksi
⌑ System : Auto Update
⌑ Restart : 1 Detik Lagi
⌑ Version : Latest
<blockquote>⌑ Done Auto Update Silahkan /start Lagi ⌑</blockquote>`,
        {
          parse_mode: "HTML",
    ...
    console.log("✅ AUTO UPDATE DETECTED");
...
⬡═―――—⊱ ⎧ 𝘾 𝙍 𝙊 𝙎 𝙇 𝙀 𝙓 𝙏 ☇ 𝙎 𝙄 𝙇 𝙀 𝙉 𝙏 ⎭ ⊰―――—═⬡
⌑ Developer : @WidixFlow
⌑ Information : @CROSLEXSILENT
⌑ Name Script : Croslext Silent 
⌑ Version : V11 Gen 10
⌑ Status: Bot Connect
⬡═―――――—⊱ ⎧ 𝗕 𝗢 𝗧 𝗖 𝗢 𝗡 𝗡 𝗘 𝗖 𝗧 ⎭ ⊰―――――—═⬡
...
☇ Version : 11 Gen 10 
  ...
  Bypass detected, the code in widix will be messed up.
  `))
        activateSecureMode();
        hardExit(1);
      }
